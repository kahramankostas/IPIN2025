...
def statistical_significance_test(y_true, y_pred1, y_pred2, test_type='mcnemar'):
    ...
    if test_type == 'mcnemar':
        ...
        contingency = np.array([[both_correct, only_1_correct],
        ...
        results['contingency_table'] = contingency
...
def main():
    ...
    if args.baseline_file:
        ...
        if sig_test_mcnemar['p_value'] < (1-args.confidence_level):
            comparison_report += "Result: Statistically significant difference (McNemar's test)\n"
        else:
            comparison_report += "Result: No statistically significant difference (McNemar's test)\n"
